...
int lsh_calc(char **args)
{
  ...
  switch (choice) {
    case 1:
      result = num1 + num2;
      printf("Addition of the two numbers: %.4f\n", result);
      break;
    case 2:
      result = num1 - num2;
      printf("Subtraction of the two numbers: %.4f\n", result);
      break;
    case 3:
      result = num1 * num2;
      printf("Multiplication of the two numbers: %.4f\n", result);
      break;
    case 4:
      if (num2 != 0) {
        result = num1 / num2;
        printf("Division of the two numbers: %.4f\n", result);
      } else {
